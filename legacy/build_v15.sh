#!/bin/bash
# Build script for YM2163 Piano GUI v15
...
echo "============================================"
echo " YM2163 Piano GUI v15 - CMake Build"
echo "============================================"
...
echo "============================================"
echo " Executable: ym2163_piano_gui_v15.exe"
echo ""
echo " Tip: Run this script again after code changes"
echo "      - only modified files will be recompiled."
echo " To force full rebuild: rm -rf ${BUILD_DIR} && ./build_v15.sh"
echo ""
